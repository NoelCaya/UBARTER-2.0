    ...
    <div class="flex-1 overflow-y-auto px-4 py-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('dashboard') }}" 
               class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-[#5a0a0b] border-l-4 border-[#f5c518]' : 'hover:bg-[#5a0a0b]' }} transition">
            ...
            <!-- Browse Items -->
            <a href="#" 
               class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-[#5a0a0b] transition">
